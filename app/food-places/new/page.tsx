...
// Server action to create a new food place
async function createFoodPlace(formData: FormData) {
  "use server"
  ...
  await foodPlaceService.createFoodPlace({
    name,
    location,
    latitude,
    longitude,
...
export default function NewFoodPlacePage() {
  return (
    <div className="w-full space-y-6">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold">Add New Food Place</h1>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Food Place Details</CardTitle>
          <CardDescription>Enter the details for the new food place</CardDescription>
        </CardHeader>
        <CardContent>
          <form action={createFoodPlace} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="priceRange" name="priceRange" placeholder="e.g. $, $, $$" required />
              </div>

              <div className="space-y-2">
                <Label htmlFor="cuisine">Cuisine</Label>
                <Input id="cuisine" name="cuisine" placeholder="e.g. Italian, Chinese, Indian" required />
              </div>

              <div className="space-y-2">
                <Label htmlFor="openingHours">Opening Hours</Label>
                <Input id="openingHours" name="openingHours" placeholder="e.g. 9 AM - 10 PM" required />
              </div>
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button type="submit">Create Food Place</Button>
            </div>
          </form>
        </CardContent>
      </Card>
